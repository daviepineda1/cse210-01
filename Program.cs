...
namespace Unit03
{
    ...
    class Program
    {
        ...
        static bool gameOver(List<string> board)
        {
            ...
            if (aWinner(board, "x") || aWinner(board, "o") || isDraw(board))
            {
                gameOver = true;
            }
        ...
        /// <returns></returns>
        static bool aWinner(List<string> board, string player)
        {
        ...
        static int getChoice(string currentPlayer)
        {
